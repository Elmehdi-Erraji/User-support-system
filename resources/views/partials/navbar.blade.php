    ...
    <div class="container d-flex justify-content-between align-items-center">            
        ...
        <div class="attr-right">
            <div class="attr-nav">
                <ul>
                    <div class="button">
                        <a class="btn circle btn-theme-effect btn-sm" href="#" style="color: black; background-color: #007bff;">Start free trial</a>
                        <a class="btn circle btn-theme-effect btn-sm" href="" style="color: black; background-color: #28a745;"> Need help ?</a>
                    </div>
                </ul>
            </div>
        </div>
