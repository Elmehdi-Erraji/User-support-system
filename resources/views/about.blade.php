        ...
        <div class="team-items">
            <div class="row">
                ...
                <div class="single-item col-lg-4 col-md-6">
                    <div class="item">
                        <div class="thumb">
                            <img src="{{ asset('assets_guest/img/team/1.jpg') }}" alt="Thumb">
                            <div class="social">
                ...
                <div class="single-item col-lg-4 col-md-6">
                    <div class="item">
                        <div class="thumb">
                            <img src="{{ asset('assets_guest/img/team/2.jpg') }}" alt="Thumb">
                            <div class="social">
                ...
                <div class="single-item col-lg-4 col-md-6">
                    <div class="item">
                        <div class="thumb">
                            <img src="{{ asset('assets_guest/img/team/3.jpg') }}" alt="Thumb">
                            <div class="social">
