                            ...
                            <div class="col-lg-6">
                                <div class="d-flex flex-column h-100">
                                    <div class="p-4 my-auto">
                                        ...
                                        <form method="POST" action="{{ route('first.login') }}" class="mt-4">
                                            @csrf                                            
                                            <div class="mb-3">
                                                <label for="email" class="form-label">{{ __('Email') }}</label>
                                                <input id="email" class="form-control @error('email') is-invalid @enderror" type="email" name="email"  placeholder="Enter your email" required autofocus />
                                                @error('email')
